...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        Personagem heroi = new Personagem("Caboclo");
        Personagem vilao = new Personagem("Poli", 2000);

        Capitulo cap1 = new Capitulo("-------------------Prólogo-------------------\n" +
        ...
        String cap1_2 = new Capitulo();

        String cap2_1 = new Capitulo();
        String cap2_2 = new Capitulo();

        String cap3_1 = new Capitulo();
        String cap3_2 = new Capitulo();

        String cap4_1 = new Capitulo();
        String cap4_2 = new Capitulo();
        ...
        if (escolha.equals("fogo")) {
            ...
            System.out.println(
                    "- Caverna. Entrar na caverna escura e fugir pelo escuro onde os Mary-bonds não podem lhe ver");
            escolha = ler.nextLine();
            ...
            if (escolha.equals("rio")) {
                ...
                System.out.println(
                        "Ao pular no rio os Mary-Bonds não se arriscaram a ir atrás do caboclo, como se uma enrgia protegesse as águas e assim eles o deixaram em paz");
                System.out.println();
                System.out.println("---------------------Cap 3-------------------");
                System.out.println();
                System.out.println(
                        " Ao chegar ao outro lado do rio, o mesmo chega todo enxarcado, e nota o céu começar clarear, subindo para a margem, suas roupas começam a "
                                +
